    ...
    public static Dictionary<byte, GBOpcode> BROpcodes = new Dictionary<byte, GBOpcode>()
        {
            ...
            {0xCA, new GBOpcode(0xCA, "JP Z, {0:x4}", 3, 16, null)},
            {0xCC, new GBOpcode(0xCC, "CALL Z, {0:x4}", 3, 24, null)},
            {0xCD, new GBOpcode(0xCD, "CALL {0:x4}", 3, 24, null)},
            {0xCF, new GBOpcode(0xCF, "RST 08H", 1, 16, null)},
            ...
            {0xD2, new GBOpcode(0xD2, "JP NC, {0:x4}", 3, 16, null)},
            {0xD4, new GBOpcode(0xD4, "CALL NC, {0:x4}", 3, 24, null)},
            {0xD7, new GBOpcode(0xD7, "RST 10H", 1, 16, null)},
            {0xD8, new GBOpcode(0xD8, "RET C", 1, 20, null)},
            {0xD9, new GBOpcode(0xD9, "RETI", 1, 16, null)},
            {0xDA, new GBOpcode(0xDA, "JP C, {0:x4}", 3, 16, null)},
            {0xDC, new GBOpcode(0xDC, "CALL C, {0:x4}", 3, 24, null)},
            {0xDF, new GBOpcode(0xDF, "RST 18H", 1, 16, null)},
            {0xE7, new GBOpcode(0xE7, "RST 20H", 1, 16, null)},
            {0xE9, new GBOpcode(0xE9, "JP HL", 1, 4, null)},
            {0xEF, new GBOpcode(0xEF, "RST 28H", 1, 16, null)},
            {0xF7, new GBOpcode(0xF7, "RST 30H", 1, 16, null)},
            {0xFF, new GBOpcode(0xFF, "RST 38H", 1, 16, null)}
        };
  }
}
