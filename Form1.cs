  ...
  public partial class Form1 : Form
  {
    ...
    private void btnLoadRom_Click(object sender, EventArgs e)
    {
      ...
      if (openFileDialog1.ShowDialog() == DialogResult.OK)
      {
        ...
        // set the title of the window to the name of the rom
        this.Text = $"{openFileDialog1.SafeFileName} - MBC Mode: {_gb._memory.MbcType.ToString("X2")} - Rom Banks: {_gb._memory.RomBankCount} - Ram Banks: {_gb._memory.RamBankCount}";
    ...
    {
      var debugForm = new DebugView(_gb);
      debugForm.Show();
    }
  }
